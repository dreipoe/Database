ALTER TABLE T_CATERER DROP COLUMN address NVARCHAR2(255) NOT NULL;
ALTER TABLE T_CATERER ADD dejureoaddr NVARCHAR2(255) NOT NULL;
ALTER TABLE T_CATERER ADD defactoaddr NVARCHAR2(255) NOT NULL;
